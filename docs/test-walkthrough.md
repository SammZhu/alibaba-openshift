...
aliyun oss mb oss://openshift-iso-samchoo-test --region cn-hangzhou
...
# 验证
aliyun oss ls oss://openshift-iso-samchoo-test/ --region cn-hangzhou
...
# 轮询状态
while true; do
  STATUS=$(aliyun ecs DescribeImages --RegionId cn-hangzhou --ImageId $IMAGE_ID \
...
或网页：[ECS Console → Images → Custom Image](https://ecs.console.aliyun.com/image/region/cn-hangzhou/imageList)
...
1. 打开 [ROS 控制台](https://ros.console.aliyun.com/cn-hangzhou/stacks/create)
...
# 期望：每行 alicloud://cn-hangzhou.i-bp1xxx
...
# https://ecs.console.aliyun.com/disk/region/cn-hangzhou/diskList ← 应只剩 ECS 系统盘
```
